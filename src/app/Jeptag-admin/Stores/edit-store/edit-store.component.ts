...
if (store_id != null) {
  ...
  //  console.log("store"+store)
    this.fields = [
      ...
      {
        label: 'Country', type: 'text', bootstrapGridClass: "col-lg-6", name: "Country", validations: [Validators.required], required: true, value: store ? store.Country : ''
      },
      {
      ...
      },
      {
        ...
        value: store ? store.status : 'online', options: Status
       }
